...
util.inherits(Cralwer, EventEmitter)
...
Cralwer.prototype.request = function(url, callback, handleError) {
   ...
   , headers: {
     ...
     if (resp.statusCode !== HTTP_STATUS_SUCCESS) {
       return handleError('HTTP statusCode： ' + resp.statusCode)
     }
     return callback(body)
   })
}

Cralwer.prototype.addProgressWhenDownloaded = function(percentInPage) {
